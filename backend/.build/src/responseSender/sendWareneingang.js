...
exports.sendWareneingang = void 0;
const Errors = __importStar(require("../error/errors"));
const sendWareneingang = async (event) => {
    try {
        ...
        return Errors.handleError(error, "sendWareneingang");
    }
};
exports.sendWareneingang = sendWareneingang;
//# sourceMappingURL=sendWareneingang.js.map